...
UserStatus as UploadCrimeDivision
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CrimeImageRef= FirebaseStorage.getInstance().getReference().child("Post Images");
        progressDialog=new ProgressDialog(this);

        Crimeref= FirebaseDatabase.getInstance().getReference().child("Posts");
        ...
        else
        {
            ...
            uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                ...
                public Task<Uri> then(@NonNull Task<UploadTask.TaskSnapshot> task) throws Exception
                {
                    ...
                    {
                        Toast.makeText(CreatePost.this, "Error occurred", Toast.LENGTH_SHORT).show();
                        ...
                        Crimeref.child(String.valueOf(count+1)).setValue(wantedData)
                                .addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task)
                                    {
                                        ...
                                        if (task.isSuccessful())
                                        {
                                            Toast.makeText(CreatePost.this, "Post Data updated..", Toast.LENGTH_SHORT).show();
                                            Intent intent=new Intent(CreatePost.this,Wanted_List.class);
