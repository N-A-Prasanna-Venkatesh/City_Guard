...
public class WantedFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(R.layout.fragment_wanted2, container, false);
        listView=v.findViewById(R.id.Fragment_list_view_wanted);

       /* Query query=FirebaseDatabase.getInstance().getReference().child("Wanted People");
        FirebaseListOptions<WantedData> options=new FirebaseListOptions.Builder<WantedData>()
                .setLayout(R.layout.post_element)
                //.setLifecycleOwner(WantedFragment.this)
                .setQuery(query,WantedData.class)
                .build();*/

        /*firebaseListAdapter=new FirebaseListAdapter(options) {
            @Override
            protected void populateView(View v, Object model, int position) {
                WantedData wantedData=(WantedData) model;

                ImageView imageView=v.findViewById(R.id.post_element_image);
                TextView tv_name=v.findViewById(R.id.post_element_name);
                TextView tv_division=v.findViewById(R.id.post_element_division);
                TextView tv_location=v.findViewById(R.id.post_element_location);

                tv_division.setText(wantedData.getDivision());
                tv_location.setText(wantedData.getLocation());
                tv_name.setText(wantedData.getName());
                Picasso.get().load(wantedData.getImage()).placeholder(R.drawable.profile_image).into(imageView);

            }
        };
        listView.setAdapter(firebaseListAdapter);*/
        mRef= FirebaseDatabase.getInstance().getReference("Wanted People");
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                myAdapter=new MyAdapter(getActivity(),names,div,loc,images,desc,ret);
        ...
        public View getView(final int position, @Nullable View convertView, @NonNull ViewGroup parent) {
            ...
            row.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("selector","Wanted");
